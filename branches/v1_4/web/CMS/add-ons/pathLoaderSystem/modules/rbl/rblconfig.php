...
global $config;
global $rblcfg;
$rblcfg['dbserver'] = $config->getValue('dbHost');//'localhost';
$rblcfg['dbuser'] = $config->getValue('dbUser');//'DBUSERNAME';
$rblcfg['dbpassword'] = $config->getValue('dbPw');//"DBPASSWORD";
$rblcfg['db'] = $config->getValue('dbName');//"DATABASE";
