<?php
	...
	$query = 'SELECT `timestamp` FROM `matches` WHERE `timestamp` LIKE ' . sqlSafeStringQuotes('2010%') . ' ORDER BY `timestamp`';
	...
	$chart->setTitle("Official GU Matches Per Hour [ 01/2005 - 09/2010 ]");
	$chart->render("img/matches.per.hour.png");
?>
